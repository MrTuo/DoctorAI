"""
Django settings for DoctorAI project.
...
SECRET_KEY = 'h8m$vwmq)lp2d9au1d&v-&kd7**%cs7!xb0%)ia!$kok2#5t%v'
...
ROOT_URLCONF = 'DoctorAI.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['AiServer/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DoctorAI.wsgi.application'
